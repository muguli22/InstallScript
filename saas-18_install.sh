...
#-------------------------------------------------------------------------------
# Make a new file:
# sudo nano saas-18_install.sh
# Place this content in it and then make the file executable:
# sudo chmod +x saas-18_install.sh
...
WEBSITE_NAME="login.tutumoses.com"
...
if [ $INSTALL_NGINX = "True" ] && [ $ENABLE_SSL = "True" ] && [ $ADMIN_EMAIL != "etu.moses@gmail.com" ]  && [ $WEBSITE_NAME != "login.tutumoses.com" ];then
